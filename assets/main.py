...
#load spritesheets
warrior_sheet = pygame.image.load("assets/images/Dhalsim/warrior.png").convert_alpha()
wizard_sheet = pygame.image.load("assets/images/Ryu/wizard.png").convert_alpha()
